    ...
    <>
      ...
      {choiceModalOpen &&
        ...
        createPortal(
          ...
          >
            <div
              className="card w-full max-w-lg p-6 my-auto flex flex-col max-h-[90vh] relative z-[101] !bg-white shadow-2xl"
              ...
              {aiVariants == null ? (
                <>
                  ...
                  <p className="mt-1 text-sm text-slate-600">
                    Send with your default template or generate AI variants for
                    this invoice.
                  </p>
                ...
                <>
                  ...
                  <p className="mt-1 text-sm text-slate-600 shrink-0">
                    Edit subject/body and add tokens (type {`{{`} for
                    suggestions). Then send with your chosen variant.
                  </p>
      ...
      {needsInput &&
        needsInput.missing_tokens.length > 0 &&
        typeof document !== "undefined" &&
        createPortal(
          <div
          ...
          >
            <div
              className="card w-full max-w-md p-6 !bg-white shadow-2xl"
              style={{ backdropFilter: "none" }}
            >
              <h2 className="text-lg font-semibold text-slate-900">
              ...
              <p className="mt-1 text-sm text-slate-600">
                Review or edit AI suggestions below, then send. You can accept
                all or change any value.
              </p>
